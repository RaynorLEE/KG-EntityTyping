...
def main(args):
    ...
    if use_checkpoint is True:
        ...
        teacher_model = MMET(args, num_entities, num_rels, num_types)
    ...
    model = LMET(args, num_entities, num_rels, num_types, [pretrained_ent_embs, pretrained_rel_embs, pretrained_type_embs])
